...
### Changed
- `GameModifier::args` is now `::cfg` suggesting it can be used for more general configuration.


## [6.0.0] - 2026-04-15

### Changed
- `Notification::LinesClearing` now includes full `lines: Vec<(usize, [TileID; Game::WIDTH])>` information.


## [5.0.0] - 2026-04-14

### Changed
- `Notification::GameEnded` finally includes `cause: GameEndCause` information.
...
### Added
- `impl TryFromf64> for ExtNonNegF64`
