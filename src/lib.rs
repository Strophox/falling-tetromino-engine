...
///
/// The [`Feedback::Debug`] variant is accessible if [`FeedbackVerbosity::Debug`] is toggled.
/// All other events are generally variants of `Feedback::Debug` but provide additional info to possibly
